...
csvpath = os.path.join("Homeworks\\03-Python\\Instructions\\PyPoll\\Resources\\election_data.csv")
...
output_file = 'Homeworks\\03-Python\\Instructions\\PyPoll\\Analysis.txt'
